...
setwd("C:/Users/Gyanaranjan Pathi/Source/Repos")

library(ROAuth)

library(twitteR)

consumer_key <- "seXvCSQFJS10UHcmxun3m27UG"

consumer_secret <- "0BtHsTW4l28fe6EeQGk438NJyY0P2ZRXmeOwi8oAfCMEzO61Vs"

access_token <- "2953071728-l1b0Vs5Rcl2JhuNImUfRAkKi2xtefQIma8MwcOR"

access_secret <- "t46hY50c4NHpxoBmnynNuFGexk5mxBIjzwKGa5vw1SqHS"
...
modi.tweets = searchTwitter("modi", n = 1000)
...
pos.words = scan("C:/Users/Gyanaranjan Pathi/Source/Repos/positive-words.txt", what = 'character ', comment.char = ';')

neg.words = scan("C:/Users/Gyanaranjan Pathi/Source/Repos/negative-words.txt", what = 'character ', comment.char = ';')
...
woeid = a_trends[which(a_trends$name == "New York"), 374]

india_trend = getTrends(woeid)

trends = india_trend[301:320]
...
tw = userTimeline("RahulGandhi", n = 1000)
...
p + coord_flip() + labs(title = "Hashtag frequencies in the tweets of the Rahul team (@RahulGandhi)")